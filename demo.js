{
    ...
    class PageTurn {
      constructor(el, pagesTotal) {
        ...
        this.DOM.pagesWrap.left.innerHTML =
          this.DOM.pagesWrap.right.innerHTML = pagesHTML;
    ...
    class Slide {
      constructor(el) {
        ...
        this.items = [];
        // The figures
        Array.from(this.DOM.el.querySelectorAll('.slide__figure')).forEach(
    ...
    class Slideshow {
      ...
      initEvents() {
        ...
        window.addEventListener('keydown', (event) => {
          ...
          if (key === 'ArrowRight') {
            ...
            this.pagethrough('next');
          } else if (key === 'ArrowLeft') {
            // Turn to the previous page
            this.pagethrough('prev');
          }
        });
      }
      ...
      updateToc(newpos) {
        ...
        this.DOM.chapter.innerHTML = this.DOM.tocItems[
          newpos
        ].querySelector('.toc__item-title').innerHTML;
      }
      ...
      navigate(newPagePos) {
        ...
        this.pageturn.turn(
          direction,
          Math.abs(this.current - newPagePos),
          () => this.switchPage(newPagePos, direction)
        );
      }
    }
